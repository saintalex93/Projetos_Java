...
public class frmSenhaFuncionarios extends javax.swing.JFrame {
    ...
    private void JCmbNomeFuncionarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JCmbNomeFuncionarioActionPerformed
        ...
        if (JCmbNomeFuncionario.getSelectedIndex() != 0) {
            ...
            AtivarCampos();
            conn.executaSql("select * from Funcionario where Nome_Func = '" + NomeFuncionario + "'");
            try {
                conn.rs.first();
                txtLogin.setText(conn.rs.getString("Login_funcionario"));
                TxtCodigo.setText(conn.rs.getString("Cod_Funcionario"));
    ...
    private void JcmbPermissaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JcmbPermissaoActionPerformed
        ...
        if (JcmbPermissao.getSelectedIndex() != 0) {
            ...
            try {
                conn.rs.first();
                CodPermissao = (conn.rs.getInt("Cod_Permissao"));
...
String NomeFuncionario, Permissao;
    ...
    public void PreencherCombobox() {
        ...
        conn.executaSql("select * from Funcionario order by Nome_Func");

        try {
            conn.rs.first();
            JCmbNomeFuncionario.addItem("<html><span style='color:#583742;font-weight: bold;'>Selecione o Funcionário...</span></html>");
            do {
                JCmbNomeFuncionario.addItem("<html><span style='color:#583742;font-weight: bold;'>" + conn.rs.getString("Nome_Func") + "</span></html>");
    ...
    public void PreencherComboboxPermissão() {
        conn.getConexao();
        conn.executaSql("select * from Permissao order by Cargo");

        try {
            conn.rs.first();
            JcmbPermissao.addItem("<html><span style='color:#583742;font-weight: bold;'>Selecione a Permissão...</span></html>");
            do {
                JcmbPermissao.addItem("<html><span style='color:#583742;font-weight: bold;'>" + conn.rs.getString("Cargo") + "</span></html>");
    ...
    public void preencherTabela(String Sql) {
        ...
        try {
            ...
            do {
                ...
                dados.add(new Object[]{conn.rs.getInt("Cod_Funcionario"), conn.rs.getString("Nome_Func"), conn.rs.getString("Login_Funcionario"),
                    conn.rs.getString("Senha_Funcionario"), conn.rs.getString("Cargo")});
