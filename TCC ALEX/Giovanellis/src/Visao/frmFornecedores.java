...
public class frmFornecedores extends javax.swing.JFrame {
    ...
    public void PreencherCombobox() {
        ...
        conn.executaSql("select distinct Nome_Fantasia from Fornecedor as forn inner join DetalheCompra as dp on dp.cod_fornecedor = forn.Cod_Fornecedor order by Nome_Fantasia asc");
        ...
        try {
            ...
            do {
                ...
                JComboFornecedores.addItem("<html><span style='color:#583742;font-weight: bold;'>" + (conn.rs.getString("Nome_Fantasia") + "</span></html>"));
    ...
    public void preencherTabela(String Sql) {
        ...
        try {
            ...
            do {
                ...
                dados.add(new Object[]{conn.rs.getInt("Cod_Fornecedor"), conn.rs.getString("Nome_Fantasia"),
                    conn.rs.getInt("Cod_Compra"), z.format(conn.rs.getDouble("Valor_Compra")), fmt.format(conn.rs.getDate("Data_Venda"))});
    ...
    void preencherTabelaDetalhe(String Sql) {
        ...
        try {
            conn.rs.first();
            do {
                dados.add(new Object[]{conn.rs.getInt("Cod_Insumo"), conn.rs.getString("Nome_Insumo"),
                    conn.rs.getInt("Quantidade"), z.format(conn.rs.getDouble("valor_insumo")), z.format(conn.rs.getDouble("Total"))});
            } while (conn.rs.next());
        } catch (Exception e) {
