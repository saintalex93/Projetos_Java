        ...
        try {
            ...
            do {
                if (conn.rs.getInt("Aviso") == 1) {
                    dados.add(new Object[]{conn.rs.getString("Nome_Func"), conn.rs.getString("Assunto"), dt.format(conn.rs.getDate("DataCriacao")), conn.rs.getString("HoraCriacao").substring(0, 5), conn.rs.getString("Mensagem"), "Não", conn.rs.getInt("CodMensagem"), conn.rs.getInt("codFunn")});
                } else {
