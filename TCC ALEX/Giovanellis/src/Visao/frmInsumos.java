...
public class frmInsumos extends javax.swing.JFrame {
 ...
 int cod = (int) JTableInsumos.getValueAt(JTableInsumos.getSelectedRow(), 2);
    ...
    public void PreencherCombobox() {
        ...
        conn.executaSql("select distinct Nome_Insumo from DetalheCompra as DC inner join Insumo as I on i.cod_insumo = DC.cod_insumo order by Nome_insumo asc");
        ...
        try {
            ...
            do {
                ...
                JcbInsumos.addItem("<html><span style='color:#583742;font-weight: bold;'>" + (conn.rs.getString("Nome_Insumo") + "</span></html>"));
    ...
    public void preencherTabela(String Sql) {
        ...
        try {
            ...
            do {
                ...
                dados.add(new Object[]{conn.rs.getInt("Cod_Compra"), conn.rs.getString("Nome_Insumo"),
                    conn.rs.getInt("Cod_Insumo"), z.format(conn.rs.getDouble("valor_insumo")), conn.rs.getInt("qdt_comprada"), z.format(conn.rs.getDouble("Total")), fmt.format(conn.rs.getDate("Data_venda"))});
...
//       JTableProdutos.getTableHeader().setDefaultRenderer(centralizado);
        ...
        try {
            ...
            do {
                ...
                dados.add(new Object[]{conn.rs.getInt("Cod_Produto"), conn.rs.getString("Nome_Produto")});
