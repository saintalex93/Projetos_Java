...
public class frmPromocoes extends javax.swing.JFrame {
    ...
    public void PreencherCombobox() {
        ...
        conn.executaSql(" select distinct Nome_Promocao from promocao as pro inner join ProdutoPromocao as pp on pp.Cod_Promocao = pro.Cod_Promocao inner join Detalhe_Pedido as dp on dp.Cod_Produto = pp.Cod_Produto order by Nome_Promocao ");
        ...
        try {
            ...
            do {
                JcomboPromocoes.addItem("<html><span style='color:#583742;font-weight: bold;'>" + conn.rs.getString("Nome_Promocao") + "</span></html>");
    ...
    public void preencherTabela(String Sql) {
        ...
        try {
            ...
            do {
//  
                dados.add(new Object[]{conn.rs.getInt("Cod_Promocao"), conn.rs.getString("Nome_Promocao"), conn.rs.getString("Nome_Produto"),
                    z.format(conn.rs.getDouble("Valor_Venda")), fmt.format(conn.rs.getDate("Data"))});
    ...
    public void preencherTabelaAgrupada(String Sql) {
        ...
        try {
            ...
            do {
                ...
                dados.add(new Object[]{conn.rs.getInt("Cod_Promocao"), conn.rs.getString("Nome_Promocao"), conn.rs.getInt("Qdt_Vendida"),
                    z.format(conn.rs.getDouble("ValorTotal"))});
