    ...
    private void btn_entrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_entrarActionPerformed
        ...
        if (validarCampos()) {
            if (usuarioExiste()) {
                ...
                try {
                    conn.conectar();
                    conn.executaSql("select * from Funcionario where Login_Funcionario = '" + NomeUsuario + "'");
                    conn.rs.first();
                    nomeFuncionario = (conn.rs.getString("Nome_Func"));
                    setPermissaoFunci(conn.rs.getInt("Cod_Permissao"));
                    codFuncionario = (conn.rs.getInt("Cod_Funcionario"));
                    conn.desconecta();
