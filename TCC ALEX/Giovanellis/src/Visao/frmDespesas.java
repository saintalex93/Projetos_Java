...
public class frmDespesas extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (CmbDespesa.getSelectedIndex() == 0) {
            ...
            if (CmbDespesa.getSelectedIndex() == 1) {
                ...
                try {
                    conn.executaSql("select * from TipoDespesa where NomeDespesa like '" + Despesa + "'");
                    conn.rs.first();
                    CodigoDespesa = (conn.rs.getString("codTipoDespesa"));
    ...
    private void jcbLancamentoDespesaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jcbLancamentoDespesaActionPerformed
        ...
        if (jcbLancamentoDespesa.getSelectedIndex() != 0) {
            ...
            conn.executaSql("select * from TipoDespesa where NomeDespesa = '" + NomeDespesa + "'");
            try {
                conn.rs.first();
                txtCodDesp.setText(conn.rs.getString("codTipoDespesa"));
    ...
    public void preencherTabela(String Sql) {
        ...
        try {
            conn.rs.first();
            do {
                dados.add(new Object[]{conn.rs.getInt("codTipoDespesa"), conn.rs.getString("NomeDespesa"), conn.rs.getString("SituacaoDespesa"), z.format(conn.rs.getDouble("ValorDespesa")), fmt.format(conn.rs.getDate("DataPagamento")), fmt.format(conn.rs.getDate("DataVencimento")), conn.rs.getInt("codDespesa")});
            } while (conn.rs.next());
        } catch (Exception e) {
    ...
    public void preencherCombo() {
        ...
        conn.executaSql("select distinct NomeDespesa from TipoDespesa as Td inner join Despesa as D on D.TipoDespesa = Td.codTipoDespesa order by NomeDespesa");
        ...
        try {
            ...
            do {
                CmbDespesa.addItem("<html><span style='color:#583742;font-weight: bold;'>" + (conn.rs.getString("NomeDespesa") + "</span></html>"));
    ...
    public void preencherComboLancar() {
        conn.getConexao();
        conn.executaSql("select NomeDespesa from TipoDespesa where SituacaoDespesa = 'Ativo' order by NomeDespesa");
        ...
        try {
            ...
            do {
                ...
                jcbLancamentoDespesa.addItem("<html><span style='color:#583742;font-weight: bold;'>" + (conn.rs.getString("NomeDespesa") + "</span></html>"));
