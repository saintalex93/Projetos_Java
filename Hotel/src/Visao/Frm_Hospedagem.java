...
public class Frm_Hospedagem extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(Lbl_QuantidadeDiarias, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 160, 140, -1));
        ...
        getContentPane().add(txtD, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 200, 50, -1));

        LblQdt.setFont(new java.awt.Font("Comic Sans MS", 1, 11)); // NOI18N
        LblQdt.setText("Quantidade");
        getContentPane().add(LblQdt, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 160, 70, -1));
        ...
        getContentPane().add(Lbl_QuantidadeCrianca, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 240, 150, -1));
        ...
        getContentPane().add(txtC, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 280, 50, -1));

        lblQdtFrigo.setFont(new java.awt.Font("Comic Sans MS", 1, 11)); // NOI18N
        lblQdtFrigo.setText("Quantidade");
        getContentPane().add(lblQdtFrigo, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 390, 70, 20));
        ...
        getContentPane().add(RdNaoFrigobar, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 360, -1, -1));
        ...
        getContentPane().add(jRadioButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 360, -1, -1));
        ...
        getContentPane().add(jc3, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 280, -1, -1));
        ...
        getContentPane().add(jc1, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 200, -1, -1));
        ...
        getContentPane().add(jc2, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 240, -1, -1));
        ...
        getContentPane().add(jc6, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 400, -1, -1));
        ...
        getContentPane().add(jc4, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 320, -1, -1));
        ...
        getContentPane().add(jc5, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 360, -1, -1));
        ...
        getContentPane().add(BtnFinalizarPesquisa, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 580, 140, -1));
        ...
        getContentPane().add(lbltotal, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 590, 180, 30));
        ...
        getContentPane().add(BtnNovaPesquisa, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 620, 140, -1));
        ...
        getContentPane().add(rd10, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 510, -1, -1));
        ...
        getContentPane().add(rd15, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 510, -1, -1));
        ...
        getContentPane().add(rd30, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 510, -1, -1));
        ...
        getContentPane().add(rd40, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 540, -1, -1));
        ...
        getContentPane().add(rd50, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 540, -1, -1));
        ...
        getContentPane().add(rd0, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 540, -1, -1));

        logo.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        logo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagem/logonovoo.png"))); // NOI18N
        getContentPane().add(logo, new org.netbeans.lib.awtextra.AbsoluteConstraints(-10, 0, 470, 150));
        ...
        getContentPane().add(rd_meia, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 440, -1, -1));

        jLabel4.setText("ACS © 2014");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 640, 70, 20));
        getContentPane().add(Txt_QdtEspecial1, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 402, 30, -1));
        ...
        getContentPane().add(Txt_qdtDuplo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 202, 30, -1));
        getContentPane().add(Txt_qdtTriplo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 242, 30, -1));
        getContentPane().add(Txt_qdtQuadruplo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 282, 30, -1));
        ...
        getContentPane().add(Txt_qdtQuintuplo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 322, 30, -1));
        ...
        getContentPane().add(Txt_qdtSextuplo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 362, 30, -1));

        jLabel5.setFont(new java.awt.Font("Comic Sans MS", 1, 11)); // NOI18N
        jLabel5.setText("Agências");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 490, -1, -1));
        ...
        getContentPane().add(Rd_Booking, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 510, -1, -1));
        ...
        getContentPane().add(Rd_trend, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 510, -1, -1));
        ...
        getContentPane().add(Rd_cvc, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 530, -1, -1));
        ...
        getContentPane().add(Rd_HotelUrbano, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 530, -1, -1));

        jPanel1.setBorder(javax.swing.BorderFactory.createEtchedBorder(java.awt.Color.white, java.awt.Color.black));
        jPanel1.setOpaque(false);
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 480, 190, 90));
        ...
        getContentPane().add(Rd_phantom, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 440, -1, -1));

        jLabel6.setFont(new java.awt.Font("Comic Sans MS", 1, 11)); // NOI18N
        jLabel6.setText("Tipo de Apartamento:");
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 160, 120, -1));

        lbl_Frigobar.setFont(new java.awt.Font("Comic Sans MS", 1, 11)); // NOI18N
        lbl_Frigobar.setText("Deseja Frigobar?");
        getContentPane().add(lbl_Frigobar, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 330, 100, 20));

        TxtQdtFrigo.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        getContentPane().add(TxtQdtFrigo, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 420, 30, -1));
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 480, 180, 90));

        LblImagem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagem/Hotels.png"))); // NOI18N
        LblImagem.setText(" ");
        getContentPane().add(LblImagem, new org.netbeans.lib.awtextra.AbsoluteConstraints(-250, 0, 860, 710));
        ...
        setSize(new java.awt.Dimension(483, 723));
...
public static double  duplos=267.00, triplos=343.00, quadruplos=423.00, quintuplos=523.00,
        sextuplos=623.00, especials=282.00,frigobar, TotalDuplos, TotalTriplos,
