...
<div id="titlePages">Área Externa</div>
<div class="margim">
  ...
  <section class="container">
    ...
    <main class="main">
      ...
      <div class="galeriaFoto">
        <a href="#"><img src="../img/externo1.JPG" alt="" onclick="onpenPhoto(this.src,0)"></a>
      </div>
      <div class="galeriaFoto">
        <a href="#"><img src="../img/externo2.JPG" alt="" onclick="onpenPhoto(this.src,1)"></a>
      </div>
      <div class="galeriaFoto">
        <a href="#"><img src="../img/externo3.JPG" alt="" onclick="onpenPhoto(this.src,2)"></a>
      </div>
      <div class="galeriaFoto">
        <a href="#"><img src="../img/externo4.JPG" alt="" onclick="onpenPhoto(this.src,3)"></a>
      </div>
      <div class="galeriaFoto">
...
var fotos = ["'../img/externo1.JPG'", "'../img/externo2.JPG'", "'../img/externo3.JPG'", "'../img/externo4.JPG'",
            "'../img/externo5.JPG'", "'../img/externo6.JPG'", "'../img/externo7.JPG'", "'../img/externo8.JPG'"],
  src,
  count;
