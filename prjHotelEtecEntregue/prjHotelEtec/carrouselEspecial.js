...
function troca(param){
    ...
    if(param === 1){
        ...
        document.getElementById('imgEspecial').src= "../img/carEspec2.JPG";
        document.getElementById("imgEspecial").style.transition = "all 0.5s";
        document.getElementById("imgEspecial").style.backgroundSize = "cover";
        ...
        document.getElementById('imgEspecial').src= "../img/carEspec3.JPG";
        document.getElementById("imgEspecial").style.transition = "all 0.5s";
        document.getElementById("imgEspecial").style.backgroundSize = "cover";
        ...
        document.getElementById('imgEspecial').src= "../img/carEspec.JPG";
        document.getElementById("imgEspecial").style.transition = "all 0.5s";''
        document.getElementById("imgEspecial").style.backgroundSize = "cover";
